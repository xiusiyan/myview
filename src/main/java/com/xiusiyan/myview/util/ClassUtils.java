...
public class ClassUtils extends org.apache.commons.lang.ClassUtils {
    ...
    public static Object instanciateClass(Class clazz,
            Object... constructorArgs) throws SecurityException,
...
//            Class[] parameterTypes, boolean voidOk, boolean matchOnObject,
...
//    public static List getSatisfiableMethods(Class implementation,
//            Class[] parameterTypes, boolean voidOk, boolean matchOnObject,
//            Collection ignoredMethodNames, WildcardFilter filter) {
...
//                    if ((returnType.equals("void") && voidOk)
...
//    }
    ...
    public static Class wrapperToPrimitive(Class wrapper) {
        return (Class) MapUtils.getObject(wrapperToPrimitiveMap, wrapper,
                                          wrapper);
    }
    ...
    public static Class[] wrappersToPrimitives(Class[] wrappers) {
        ...
        for (int i = 0; i < wrappers.length; i++) {
            primitives[i] = (Class) MapUtils
                    .getObject(wrapperToPrimitiveMap, wrappers[i], wrappers[i]);
        }
    ...
    public static void addLibrariesToClasspath(List urls)
        ...
        if (!(sys instanceof URLClassLoader)) {
            throw new IllegalArgumentException(
                    "PANIC: Mule has been started with an unsupported classloader: "
